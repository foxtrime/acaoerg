...
<tr>
    ...
    if(count($erros) == 0){
        $endereco[0] = "revista@ergonomia.ufrj.br";
        $endereco[1] = "suporte@ergonomia.ufrj.br";
        $assunto     = "RevistaOnLine - Contato";
...
//        echo    '<p align="right">' . $diaSemana[date("w")] . ", " . $diaMes . " de " . $mesAno[date("n") -1] . " de " . $ano . ".</p><br><br>";
        ...
        <p align='center'><button class='button' onClick="javascript:irParaPagina('index.php')">Voltar</button></p>
    ...
    <?php } ?>
    <p align='center'><button class='button' onClick="irParaPagina('faleConosco.php')">Voltar</button></p>
    <?php } ?>
    </td>
</tr>
</table>
